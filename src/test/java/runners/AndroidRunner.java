...
public class AndroidRunner extends AbstractTestNGCucumberTests{
    ...
    public void setupDriver() throws MalformedURLException, InterruptedException{
        ...
        caps.setCapability("appPackage", "com.google.android." + Constants.mobileAppName);
        caps.setCapability("appActivity", "com.android." + Constants.mobileAppActivity);
    ...
    public void beforeTestMethod(){
        ...
        htmlReporter = new ExtentSparkReporter(System.getProperty("user.dir") + File.separator + "reports" + File.separator + "AndroidAutomationReport.html");
